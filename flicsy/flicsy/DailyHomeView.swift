    ...
    var body: some View {
        ...
        ZStack {
            if (revealed && submitted) {
                ...
                ReflectionCard(submitted: $submitted, typing: $typing, date: $photoDateData, dailyImage: $dailyImage, tabSelection: $tabSelection).opacity(0)
            } else {
                ReflectionCard(submitted: $submitted, typing: $typing, date: $photoDateData, dailyImage: $dailyImage, tabSelection: $tabSelection).opacity(flipped ? 0 : 1)
                DailyFlicCard(photoDateData: $photoDateData,
                              photoLocationData: $photoLocationData,
                              photoLocality: $photoLocality,
                              photoAdministrativeArea: $photoAdministrativeArea,
